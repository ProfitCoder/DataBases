...
-- 13. Seleccionar los nombres de los empleados que su nombre comienza por A.

SELECT NombreEmpl
FROM Empleado
WHERE NombreEmpl LIKE 'A%';

-- 14. Obtener una lista ordenada alfabéticamente de los empleados que trabajan en el departamento número 30.
...
-- 15. Obtener una lista de los empleados ordenados por trabajo en orden alfabético y por orden decreciente de sueldo.

SELECT *
FROM Empleado
ORDER BY sueldo Desc,Empleo;

-- 16. ¿Cuáles son los tipos de trabajo que se desempeñan en una empresa?

SELECT Empleo
FROM Empleado
ORDER BY Empleo;

-- 17. ¿En qué estado trabaja el empleado Allen?

SELECT NombreEmpl,Empleo
FROM Empleado
WHERE NombreEmpl = 'Allen';

-- 18. Obtener el sueldo máximo de cada departamento.

SELECT NumDep,MAX(sueldo) AS Sueldo_Maximo
FROM Empleado 
GROUP BY numDep;

-- 19. ¿Cuáles son los departamentos que tienen un salario máximo superior a 4000?
